...
The project is inspired by the <InlineLink href='https://observablehq.com/@toja/d3-ternary-plot' text='observable notebook of Torben Jansen'/> which served as a starting point.
