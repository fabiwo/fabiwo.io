---
title: Ternary Equilibrium - Ternary Graphs Made Easy
date: '2021-02-06'
...
This article is not only the first blog entry of mine but also the official launch of my first application.🥳

I am launching my application <InlineLink href='https://ternary-alpha.herokuapp.com/' text='Ternary Equilibrium'/> and blog at the same time.
...
For people new to ternary graphs I am going to cover the basics to read and understand them. If you just want to try the application you can jump straight ahead to <InlineNavLink href='#4-how-to-use-' text='How to Use 🌍'/> or <InlineLink href='https://ternary-alpha.herokuapp.com/' text='launch the application 🚀'/>.
...
Since you have three variables, you need three axes to display them. For convenience I am going to name the axes (see a left triangle in the picture):
